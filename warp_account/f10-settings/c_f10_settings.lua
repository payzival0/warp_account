...
function showSettingsWindow(tab)
	...
	GUIEditor_Checkbox.streams = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Radio'yu kullanıma kapat",false,true,GUIEditor_Tab.graphicSettings)
	...
	local vehicle_rims = exports.global:isResourceRunning('vehicle_rims') and true or false
	...
	guiSetEnabled(GUIEditor_Checkbox.vehicle_rims, vehicle_rims)
