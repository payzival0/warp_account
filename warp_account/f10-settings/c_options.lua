...
addEvent("accounts:ayarac",true)
addEventHandler("accounts:ayarac",root,function()
showSettingsWindow()
...
--  triggerEvent( 'hud:blur', resourceRoot, 6, false, 0.5, nil )
	...
	if getResourceFromName("faction-system") and exports['faction-system']:canAccessFactionManager( localPlayer ) then
...
function options_logOut( message )
	triggerServerEvent("updateCharacters", localPlayer, localPlayer)
